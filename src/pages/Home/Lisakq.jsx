...
const Lisakq = () => {
  return (
    <div className='bg-white w-[100%] h-[100vh] flex items-center'>
       <div className='grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-6 relative lg:px-36 md:px-5 px-6'>
           {/* ball */}
           ...
           {/* ball */}
          <img src={image} className='relative lg:top-0 md:top-0 top-10 w-[100%] lg:h-[70vh] md:h-[40vh] h-[40vh] object-cover rounded-2xl' />
          <div className='py-8 flex items-center relative z-10'>
            <div>
            <h1 className='lg:text-3xl md:text-2xl text-lg font-semibold lg:mb-4 md:mb-4 mb-2'><span className='font-bold text-green'>LISAK</span> WATER COMPANY TREATS THE WATER WITH LATEST TECHNOLOGY.</h1>
