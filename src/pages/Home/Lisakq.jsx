    ...
    <div className='bg-white w-[100%] h-[100vh] flex items-center'>
       <div className='grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 lg:px-36 md:px-10 px-6'>
          ...
          <div className='py-8 flex items-center'>
            <div>
            <h1 className='lg:text-3xl md:text-2xl text-2xl font-semibold mb-4'><span className='font-bold text-green'>LISAK</span> WATER COMPANY TREATS THE WATER WITH LATEST TECHNOLOGY.</h1>
