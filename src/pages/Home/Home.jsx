...
const Home = () => {
  return (
    <div className='w-[100%] h-[100vh] relative overflow-hidden bg-aliceblue flex justify-center items-center'>
        <img src={bg} className='absolute left lg:-bottom-64 md:-bottom-60 -bottom-4'/>
       <div className='grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 w-[80%] relative lg:px-20 md:px-20 px-2'>
        ...
        <p className='text-lg'>High Natual Pure and Clean Water From NAture</p>
        </div>   
        </div>

         <div className='flex justify-end'>
          <div className='lg:w-[60%] md:w-[80%] lg:h-[40vh] md:h-[25vh] h-[40vh] bg-green hover:border hover:scale-110 duration-700 px-4 rounded-2xl shadow-sm'>
