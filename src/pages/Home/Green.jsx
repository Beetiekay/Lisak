...
import image from "../../assets/comp1.png"

const Green = () => {
  return (
    <div className='w-[100%] lg:h-[70vh] md:h-[50vh] h-fit relative n flex justify-center items-center bg-white px-4'>
        <div className='lg:w-[50%] md:w-[80%] overflow-hidden bg-green bg-opacity-90 rounded-2xl shadow-md py-8 px-6'>
            <img src={image} className='w-[100%] lg:-top-44 md:-top-10 -top-16 right-0 left-0 absolute'/>
            <h1 className='text-4xl font-semibold text-white mb-2'>Going Green <span>?</span></h1>
